...
public class AuthorizationFilter extends BasicAuthenticationFilter {
	...
	protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
		...
		String authorizationHeader = req.getHeader(env.getProperty("authentication.token.header.name"));
		...
		UsernamePasswordAuthenticationToken authentication = getAuthentication(req, authorizationHeader);
		SecurityContextHolder.getContext().setAuthentication(authentication);
		chain.doFilter(req, res);
	}

	private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest req, String authorizationHeader) {
